...
public class OtherQuestionAnswerView extends javax.swing.JFrame {
    ...
    /**
     * Creates new form OtherQuestionAnswerView
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OtherQuestionAnswerView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OtherQuestionAnswerView().setVisible(true);
            }
        });
    }
