...
public class MediumQuestionWrongView extends javax.swing.JFrame {
    ...
    /**
     * Creates new form MediumQuestionWrongView
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MediumQuestionWrongView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MediumQuestionWrongView().setVisible(true);
            }
        });
    }
