 ...
 * @author bonnychen
 */
public class EasyQuestionView extends javax.swing.JFrame {

    /**
     * Creates new form EasyQuestionView
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EasyQuestionView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EasyQuestionView().setVisible(true);
            }
        });
    }
